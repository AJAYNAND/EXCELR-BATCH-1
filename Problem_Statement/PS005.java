...
public class TestEmployee {
    public static void main(String[] args) {
        ...
        System.out.println("Get Employee List: " + collectionMap.getEmployeeList()); // Expected: List of employees
                                                                                     // (only emp1)

        // Add more employees and list them
        collectionMap.addEmployee(emp3);
        System.out.println("Get Updated Employee List: " + collectionMap.getEmployeeList()); // Expected: List with emp1
                                                                                             // and emp3
    }
}